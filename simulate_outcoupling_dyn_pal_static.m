%simulate_outcoupling_dyn_pal_static
...
sim_opt.grav=const.g0;
sim_opt.nsamp=10e6;%number of atoms to simulate
sim_opt.osc.time_offset=0;
sim_opt.samp_dynamics_times=[0,2.0,4.30,7.2,11.0]*1e-3;
sim_opt.t_end=12e-3;
sim_opt.verbose=2;
...
time_querys=[2.0,4.30,7.2,11.0]*1e-3;
...
for ii=1:iimax
    ...
    hist_opt.hist_bounds=[[-40,40];[-40,40];[-40,80]]*1.1*1e-3;
...
set(gcf,'Position',[-1800,355,fig_width_px,fig_width_px*fig_aspect_ratio])
%grid on
fig_name='pal_static_hist_dyn_vel';
fig_dir='./figs/thesis_figs';
export_fig(fullfile(fig_dir,strcat(fig_name,'.svg')))
%export_fig(fullfile(fig_dir,strcat(fig_name,'.pdf')))
...
for ii=1:iimax
    ...
    hist_opt.density_power=0.4;
    %tf_details.pal_vmax
    hist_opt.hist_bounds=[[-40,40];[-40,40];[-40,80]]*1e-3*time_this;
...
set(gcf,'Position',[-1800,355,fig_width_px,fig_width_px*fig_aspect_ratio])
%grid on
fig_name='pal_static_hist_dyn_pos';
fig_dir='./figs/thesis_figs';
export_fig(fullfile(fig_dir,strcat(fig_name,'.svg')))
%export_fig(fullfile(fig_dir,strcat(fig_name,'.pdf')))
exportgraphics(fh,fullfile(fig_dir,strcat(fig_name,'.pdf')))
...
[hist_fig,ch]=hist_2d_data( sim_out.final.vel.vals,hist_opt);
ch.Ticks=linspace(0,ch.Ticks(end),6);


hold on
cir_r=tf_details.pal_vmax;
cir_theta = linspace(0.5*pi,1.5*pi,100)+pi;
cir_cen=[0,4]*1e-3;
...
%%
%grid on
fig_name='pal_hist_static_bcr_sim';
fig_dir='./figs/thesis_figs';
export_fig(fullfile(fig_dir,strcat(fig_name,'.svg')))
%export_fig(fullfile(fig_dir,strcat(fig_name,'.pdf')))
exportgraphics(fh,fullfile(fig_dir,strcat(fig_name,'.pdf')))
